...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    socket.on('recivemessage', ({ message, senderId,username }) => {
    ...
    socket.on('reciveSongDetails',(song)=>{ 
      if(song){
        setSong(song)
      }
    })
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100">
      ...
      <div className="flex-1 overflow-y-auto p-4 bg-white md:bg-gray-100">
        <div className="max-w-4xl mx-auto space-y-4 pb-1">
...
>
  <Music size={24} />
            ...
            <input
              className="flex-1 border rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-700"
              type="text"
            ...
            <button
              type="submit"
              className="ml-2 p-2 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full text-white hover:shadow-md transition-shadow duration-300"
